 ...
 */
final class Version20241103161023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, registration_number VARCHAR(255) NOT NULL, vin VARCHAR(17) NOT NULL, client_email VARCHAR(100) DEFAULT NULL, is_rented TINYINT(1) NOT NULL, brand_id INT NOT NULL, client_address_id INT DEFAULT NULL, current_location_id INT DEFAULT NULL, INDEX IDX_1B80E48644F5D008 (brand_id), INDEX IDX_1B80E48665E39234 (client_address_id), INDEX IDX_1B80E486B8998A57 (current_location_id), UNIQUE INDEX unique_vin (vin), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
